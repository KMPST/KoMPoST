            ...
            void Setup(int NumberOfPoints,double Sigma){
                ...
                for(int tIndex=0;tIndex<NumberOfTimes;tIndex++){
                    ...
                    if(KoMPoSTParameters::KineticTheory=="RTA"){
                        ss << "RTA/ENERGYRESPONSE/EnergyGreensFunctionT" << tStart << "-" << (tStart+tOffset+tIndex) << ".txt";
                        MomentumSpace::Setup(ss.str(),512);
                    }
        ...
        namespace KineticTheory{
            ...
            void Setup(int NumberOfPoints,double Sigma){
                ...
                for(int tIndex=0;tIndex<NumberOfTimes;tIndex++){
                    ...
                    if(KoMPoSTParameters::KineticTheory=="RTA"){
                        ss << "RTA/MOMENTUMRESPONSE/MomentumGreensFunctionT" << tStart << "-" << (tStart+tOffset+tIndex) << ".txt";
                        MomentumSpace::Setup(ss.str(),512);
                    }
