...
class EKTPhoton{
    ...
    // Compute pre-equilibrium photon rates based on universal scaling function in XXX for a given eta/s and CIdeal
	...
	gsl_interp_accel *acc10[NSteps];
    gsl_spline *RateInt10[NSteps];
    ...
    double Steps10[NSteps];
    double Tau10[NSteps];
    double T10[NSteps];
    double wTilde10[NSteps];
